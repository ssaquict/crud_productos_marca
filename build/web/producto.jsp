...
<html>
    ...
    <body>
        ...
        <form action="sr_producto?btn_agregar=guardar" method="post" class="form-group" enctype="multipart/form-data">
                ...
                <input type="file" name="fileImagen" id="fileImangen" class="form-control" placeholder="Ejemplo Imagen">
